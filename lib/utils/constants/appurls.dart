class AppUrl{
  ...
  static const String getProductsbyuserid = "$baseUrl/getProductsbyuserid";
  static const String getProductbycategory = "$baseUrl/getProductbycategory";
  static const String getexclusive_stuffy = "$baseUrl/getexclusive_stuffy";
  static const String getnewest_stuffy = "$baseUrl/getnewest_stuffy";
  static const String termsandcondition = "$baseUrl/termsandcondition";
  static const String privacyPolicy = "$baseUrl/privacyPolicy";
  static const String forgotPassword = "$baseUrl/forgotPassword";
  static const String plans = "$baseUrl/plans";
  static const String updateplan = "$baseUrl/updateplan";
  static const String addgallery = "$baseUrl/addgallery";
  static const String sharing = "$baseUrl/sharing";
