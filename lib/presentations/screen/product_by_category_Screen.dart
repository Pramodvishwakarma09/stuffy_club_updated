...
import '../../domain/models/product_by_category_model.dart';
...
class _ProductByCategoryState extends State<ProductByCategoryScreen> {
  ...
  Future<ProductByCategoryModel> fechData() async {
    ...
    String url = AppUrl.getProductbycategory;
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      //       fontFamily: 'Aboshi', fontWeight: FontWeight.w400,color: colors.black1,
      //       height:2),),
      //
      ...
      //
      // ),
      appBar: customAppBar("${widget.cname}",context),
      body: SafeArea(
        child: FutureBuilder(
            future: fechData(),
